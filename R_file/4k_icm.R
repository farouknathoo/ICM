...
R  <- 51 #NUMBER OF ICM ITERATIONS TO RUN
...
while (r < R) {
  ...
  cat("Iteration = ",r,"Time = ",time.iter[3]," seconds", "corr.iter =",cor.iter,"rmse = ",rmse,"Z.state = ", table(Z.state),"\n")
  r <- r+1
} 